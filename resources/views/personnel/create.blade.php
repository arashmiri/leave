            ...
            <div class="flex flex-col items-start">
              <div class="flex items-center justify-center space-x-14 space-x-reverse">
                <div>
                  ...
                  <input autocomplete="off" type="text" name="name" id="" class="p-2 outline-none border-[1px] rounded-lg border-1 shadow-lg border-gray-400 name-input placeholder:text-sm"
                    placeholder="نام و نشان را وارد نمایید:">
                </div>
                  <div class="flex items-center justify-center space-x-2 space-x-reverse">
                    <label class="text-lg badage-label">درجه: </label>
                    <select autocomplete="off" name="rank"
          ...
          <div class="grid grid-cols-3 gap-10">
            <div class="flex flex-col items-center justify-center w-72 h-28 bg-gray-100 space-y-2 rounded-md shadow-lg placeholder:text-sm">
              ...
              <div class="flex space-x-2 space-x-reverse">
                <input autocomplete="off" type="text" name="personnel_code" id=""
            ...
            <div class="flex flex-col items-center justify-center w-72 h-28 bg-gray-100 space-y-2 rounded-md shadow-lg">
              ...
              <div class="flex space-x-2 space-x-reverse">
                <input autocomplete="off" type="text" name="battalion" id="" class="p-2 outline-none border-[1px] rounded-lg border-1 shadow-lg border-gray-400 address-input placeholder:text-sm"
            ...
            <div class="flex flex-col items-center justify-center w-72 h-28 bg-gray-100 space-y-2 rounded-md shadow-lg">
              ...
              <div class="flex space-x-2 space-x-reverse">
                <input autocomplete="off" type="text" name="entitlement" id="" class="p-2 outline-none border-[1px] rounded-lg border-1 shadow-lg border-gray-400 address-input placeholder:text-sm"
